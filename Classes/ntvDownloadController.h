...
#import "ntvProgressBarControl.h"

@class BRHeaderControl, BRTextControl, ntvProgressBarControl, NSURLDownload;

@interface ntvDownloadController : BRController
{

    BRHeaderControl *       _header;
    BRTextControl *         _sourceText;
	ntvProgressBarControl *  _progressBar;
