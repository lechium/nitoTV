...
@implementation ntvDownloadController
...

{
	...
	_progressBar = [[ntvProgressBarControl alloc] init];
	
	// work out our desired output path
	_outputPath = [[ntvDownloadController outputPathForURLString: urlstr] retain];
