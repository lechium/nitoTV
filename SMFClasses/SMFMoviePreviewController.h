...
static char const * const kSMFMoviePreviewSummary;
static char const * const kSMFMoviePreviewPosterPath;
static char const * const kSMFMoviePreviewPoster;
static char const * const kSMFMoviePreviewHeaders;
static char const * const kSMFMoviePreviewColumns;
static char const * const kSMFMoviePreviewRating;
static char const * const kMoviePreviewControllerSelectionChanged;
static char const * const kMoviePreviewControllerNewSelectedControl;
